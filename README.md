...
Лицензия разрешает коммерческое использование, но надо учитывать что лицензия накладывает ряд ограничений. Основные ограничения: использования торговой марки (Trademark use) - нельзя искажать торговую марку Node-RED (принадлежащую OpenJS Foundation) и ограничение ответственности (Liability/Warranty), то есть участники проекта не могут быть обвинены в причинении каких либо вероятных убытков.
