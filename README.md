...
Чтобы было повеселее, предположим что есть гениальная идея создания уникального приложения для "Подключаемых Автомобилей", которое требует быстрой апробации некоторых концепций и пусть это будет первый шаг на этом пути.
