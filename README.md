...
Ну а Node-RED скачать может любой желающий и совсем безвозместно. При первом знакомстве Node-RED конечно вызывает некоторые вопросы в плане логики работы и прививает определенную любовь к узлу "debug" и вкладке "debug messages"
