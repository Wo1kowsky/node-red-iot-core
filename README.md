...
Написано уже немало статей на тему использования средств визуального программирования при создании приложений для Интеренета Вещей, управления разнообразными устройствами и домашней автоматизации. Однако мало кто упоминает о другом полезном свойстве подобных иструментов - это быстрое прототипирование и визуализация результатов без грубоких знаний в программировании.
...
https://habr.com/ru/post/396985/
https://habr.com/ru/company/tinkoff/blog/487984/
