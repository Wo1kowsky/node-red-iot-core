...
Node-RED действительно скачать может любой желающий и совсем безвозместно. При первом знакомстве Node-RED вызывает некоторые вопросы в плане логики работы и прививает какую-то свою непередаваемую любовь к узлу "debug" и вкладке "debug messages", но после того как осмотришься и поймешь как все устроено, то все встает на свои места и действительно становится очень просто. Совсем без познаний в программировании обойтись не получится, требуется хоть какое-то представление о том, что такое массивы, JSON сообщения и как осуществлять их разбор. Тем не менее, узлы из раздела "Network", такие как "mqtt in/out" заработали с сервисом Яндекса IoT Core вообще без проблем при условии их правильной конфигурации.

## Полезные материалов (ссылки)
